...
<div id="outer">
  <div id="outer2">
    ...
    <div id="content">
      <div id="column1">
      <form:form  id="customerfrm" class="formular">
      <h3>customer</h3>
<a href="/Ked2/customer/addcustomer">Add customer</a>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="display"
					...
					<tbody>
						<c:forEach items="${customerlist}" var="customer">
							<tr class="gradeX">
								<td><a href="/Ked2/customer/viewcustomer/${customer.id}">${customer.name}</a>
								</td>
